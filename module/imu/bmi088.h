...
#define GYRO_X_OFFSET 0.00116697722f
#define GYRO_Y_OFFSET -0.000161034186f
#define GYRO_Z_OFFSET 0.000642216881f
#define ACCEL_X_OFFSET 0.000642216881f
#define ACCEL_Y_OFFSET -0.222740591f
#define ACCEL_Z_OFFSET 0.0f
#define G_NORM 9.78288746f // 重力加速度
// 陀螺仪默认环境温度
